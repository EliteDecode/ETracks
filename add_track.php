...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-10 col-xl-10">
                <div class="container tabss">
                    ...
                    <div class="form">
                        <div id="msg"></div>
                        <?php $response = selectOne('admin', ['Email' => $ad]); ?>
                        ...
                        <div id="form1">
                            ...
                            <form method="post" enctype="multipart/form-data" class="adminLoginForm"
                                style='margin-top:3%'>
                                <input type="hidden" value="<?php echo $response['Fullname'] ?>" id="added_by">
                        ...
                        <div id="form3" style='display:none'>
                            ...
                            <form method="post" enctype="multipart/form-data" class="adminLoginForm"
                                ...
                                <div class="form-group">
                                    <label for="expiry_date">Expiring Date</label>
    ...
    function submit() {
        ...
        var vars = 'firstname=' + firstname + '&lastname=' + lastname + '&email=' + email + '&phone=' + phone +
            ...
            server_link + '&expiry_date=' + expiry_date + '&stats=' + stats + '&added_by=' + added_by;
