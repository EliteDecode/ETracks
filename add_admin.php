...
<body>
                    ...
                    <div class="form">
                        ...
                        <form method="post" enctype="multipart/form-data" class="adminLoginForm" style='margin-top:3%'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" class="form-control bold" id='fullname' value=""
                                    placeholder="Add Admin's Fullname..." />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" class="form-control bold" id='phone' value=""
                                    placeholder="Add Admin's Phone Number......" />
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" name="password" class="form-control bold" id='password' value=""
                                    placeholder="Add Admin's Password ......" />
                            </div>
                            <div class="form-group">
    ...
    function submit() {
        ...
        var method = 'POST';
        var url = 'ajax/ajax_add_admin.php';
