        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-10 col-xl-10">
                ...
                <div class="container tabss">
                    <h6 class='track'>Total Track Records 100% Completed: <?php $row =  selectAll('track', ['stats' => 'yes']);
                                                   $num =count($row);
                                                  echo $num?></h6>
                    ...
                    <table class='table table-bordered  text-center' style='z-index:0;margin-top:1%; color:#085e79;'>
                        <tr>
                            ...
                            ?>
                            <?php else: ?>
                            <th style='font-size:13px'>Added By</th>
                            <?php endif ?>
                        ...
                        <tr>
                            ...
                            ?>
                            <?php else: ?>
                            <td style='font-size:13px'><?php echo $ro['added_by'] ?></td>
                            <?php endif ?>
                            ...
                            <td style='font-size:13px'><button style="font-weight:bold;" class='btn btn-secondary'
                                    onclick="maintain(this)" id="<?php echo $ro['id']?>">Maintain</button></td>
                        ...
                        <tr>
                            <td colspan="18" style="font-weight: bold;"> No track Currently on List. </td>
                        </tr>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item <?php echo $disabledFirst?> ">
                                <a class="page-link" href="tracks.php?page=<?php echo $first ?>" tabindex="-1">First</a>
                            </li>
                            <li class="page-item  <?php echo $disabledPrev?> ">
                                <a class="page-link " href="tracks.php?page=<?php echo $previous ?>" tabindex="-1"><i
                            ...
                            <li class="page-item"><a class="page-link " id='active'
                                    href="tracks.php?page=<?php echo $i ?>"
                            ...
                            <li class="page-item <?php echo $disabledNext?>">
                                <a class="page-link" href="tracks.php?page=<?php echo $next ?>"><i
                                        class="fa fa-caret-right" style='cursor:pointer'></i></a>
                            </li>
                            <li class="page-item <?php echo $disabledLast?> ">
                                <a class="page-link" href="tracks.php?page=<?php echo $last ?>" tabindex="-1">Last</a>
                            </li>
                        </ul>
                    </nav>
                    <?php else: ?>
