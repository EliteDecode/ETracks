...
if (empty($firstname)) {
   ...
   $error['empty'] = 'Expiry Date Is Required';
...
$result = selectOdd('track', $data);
if ($result != NULL) {
    $error['empty'] = 'Project with This Name Exists Already';
 }
 ...
 if (count($error) == 0) {
    ...
    <h6 style="font-size:12px;" class="alert alert-success text-dark" >Information Updated succesfully</h6></div>';
 }
