...
if (empty($fullname)) {
   $error['empty'] = 'Admin Fullname Is Required';
    ...
    $error['empty'] = 'Admin Status Is Required';
 }
 ...
 if (count($error) == 0) {
   ...
   $datas = [
    ...
    <h6 style="font-size:12px;" class="alert alert-success text-dark" >Admin Information Edited succesfully</h6></div>';
 }
